...
import static code.with.bingyang.wei.hogwartsartifactsonline.system.StatusCode.INVALID_ARGUMENT;
...
class WizardControllerIntegrationTest {
    ...
    void testFindAllWizardsSuccess() throws Exception {
        this.mockMvc.perform(get(this.baseUrl + "/wizards").accept(APPLICATION_JSON).header(AUTHORIZATION, this.token))
    ...
    void testFindWizardByIdSuccess() throws Exception {
        this.mockMvc.perform(get(this.baseUrl + "/wizards/1").accept(APPLICATION_JSON).header(AUTHORIZATION, this.token))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
    ...
    void testFindWizardByIdNotFound() throws Exception {
        this.mockMvc.perform(get(this.baseUrl + "/wizards/5").accept(APPLICATION_JSON).header(AUTHORIZATION, this.token))
    ...
    void testAddWizardSuccess() throws Exception {
        ...
        this.mockMvc.perform(post(this.baseUrl + "/wizards").contentType(APPLICATION_JSON).content(json).accept(APPLICATION_JSON).header(AUTHORIZATION, this.token))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
    ...
    void testUpdateWizardSuccess() throws Exception {
        ...
        this.mockMvc.perform(put(this.baseUrl + "/wizards/1").contentType(APPLICATION_JSON).content(json).accept(APPLICATION_JSON).header(AUTHORIZATION, this.token))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
    ...
    void testUpdateWizardErrorWithNonExistentId() throws Exception {
        ...
        this.mockMvc.perform(put(this.baseUrl + "/wizards/5").contentType(APPLICATION_JSON).content(json).accept(APPLICATION_JSON).header(AUTHORIZATION, this.token))
                .andExpect(jsonPath("$.flag").value(false))
                .andExpect(jsonPath("$.code").value(StatusCode.NOT_FOUND))
                .andExpect(jsonPath("$.message").value("Could not find wizard with Id 5 :("))
                .andExpect(jsonPath("$.data").isEmpty());
    ...
    void testDeleteWizardSuccess() throws Exception {
        this.mockMvc.perform(delete(this.baseUrl + "/wizards/3").accept(APPLICATION_JSON).header(AUTHORIZATION, this.token))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
                .andExpect(jsonPath("$.message").value("Delete Success"));
        this.mockMvc.perform(get(this.baseUrl + "/wizards/3").accept(APPLICATION_JSON).header(AUTHORIZATION, this.token))
                .andExpect(jsonPath("$.flag").value(false))
                .andExpect(jsonPath("$.code").value(StatusCode.NOT_FOUND))
    ...
    void testDeleteWizardErrorWithNonExistentId() throws Exception {
        this.mockMvc.perform(delete(this.baseUrl + "/wizards/5").accept(APPLICATION_JSON).header(AUTHORIZATION, this.token))
                .andExpect(jsonPath("$.flag").value(false))
                .andExpect(jsonPath("$.code").value(StatusCode.NOT_FOUND))
                .andExpect(jsonPath("$.message").value("Could not find wizard with Id 5 :("))
                .andExpect(jsonPath("$.data").isEmpty());
    ...
    void testAssignArtifactSuccess() throws Exception {
        this.mockMvc.perform(put(this.baseUrl + "/wizards/2/artifacts/12334545").accept(APPLICATION_JSON).header(AUTHORIZATION, this.token))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
    ...
    void testAssignArtifactErrorWithNonExistentWizardId() throws Exception {
        this.mockMvc.perform(put(this.baseUrl + "/wizards/0/artifacts/12334545").accept(APPLICATION_JSON).header(AUTHORIZATION, this.token))
                .andExpect(jsonPath("$.flag").value(false))
                .andExpect(jsonPath("$.code").value(StatusCode.NOT_FOUND))
    ...
    void testAssignArtifactErrorWithNonExistentArtifactId() throws Exception {
        this.mockMvc.perform(put(this.baseUrl + "/wizards/2/artifacts/0").accept(APPLICATION_JSON).header(AUTHORIZATION, this.token))
                .andExpect(jsonPath("$.flag").value(false))
                .andExpect(jsonPath("$.code").value(StatusCode.NOT_FOUND))
                .andExpect(jsonPath("$.message").value("Could not find artifact with Id 0 :("))
                .andExpect(jsonPath("$.data").isEmpty());
    }
