...
public class AuditLogger {
	...
	/**
	 * Log data when authentication is success: auditOnSuccessAuthentication.
	 */
    @EventListener
	...
	/**
	 * Log data when authentication is failed: auditOnFailedAuthenticationBadCredentials.
	 * We could have done these logics inside the `CustomBasicAuthenticationEntryPoint`, `CustomBearerTokenAccessDeniedHandler`, `CustomBearerTokenAuthenticationEntryPoint`.
	 * <br>
	 * Note that; I'm only logging the `AuthenticationFailureBadCredentialsEvent` which will log when only the credential set given by the user is invalid. Otherwise, no logs
	 * will be printed.
	 */
    @EventListener
